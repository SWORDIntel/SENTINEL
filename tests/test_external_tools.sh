...
test_setup() {
    ...
    # Source the module
    source "$SENTINEL_INSTALL_DIR/bash_modules.d/logging.module"
    source "$SENTINEL_INSTALL_DIR/bash_modules.d/config_cache.module"
    source "$SENTINEL_INSTALL_DIR/bash_modules.d/external_tools.module"
}
