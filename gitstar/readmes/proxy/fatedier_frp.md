...
origin: fatedier
risk_level: medium
possible_abuse: covert tunneling, bypassing firewalls
hardening_tips: monitor for unauthorized tunnels, restrict outbound connections
related: proxy, tunneling, frp, firewall bypass
opsec: medium

tags: [proxy, tunneling, frp, firewall-bypass, network]
-->
# frp
