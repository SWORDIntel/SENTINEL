...
origin: puzzlepeaches
risk_level: medium
possible_abuse: credential stuffing, brute force
hardening_tips: enforce MFA, monitor for failed logins
related: password spraying, credential stuffing, brute force
opsec: medium

tags: [osint, password-spraying, credential-stuffing, brute-force, resource]
-->
