...
origin: positive-security
risk_level: medium
possible_abuse: tracking, privacy violation
hardening_tips: anonymize sensitive data, monitor for location lookups
related: location, osint, tracking, privacy
opsec: medium

tags: [osint, location, tracking, privacy, recon]
-->
# Find You
...
More information can be found here: [https://positive.security/blog/find-you](https://positive.security/blog/find-you)

![Find You Cover](Resources/FindYouCover.png)
...
OpenHaystack and Find You is licensed under the [**GNU Affero General Public License v3.0**](LICENSE).
