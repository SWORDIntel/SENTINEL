<!--
category: network
subcategory: telecom-resource-list
origin: ravens
risk_level: low
possible_abuse: mapping telecom infrastructure
hardening_tips: restrict access to sensitive resources
related: telecom, nfv, openstack, kubernetes, cnf
opsec: low

tags: [telecom, nfv, openstack, kubernetes, cnf, resource, network]
-->
# awesome-telco
