# PowerShell script to fix the text_formatting file
# This script replaces the file content with the correct version

Write-Host "Fixing text_formatting file..."
...
[System.IO.File]::WriteAllText("$PWD\bash_aliases.d\text_formatting", $content)

Write-Host "The text_formatting file has been fixed." 